fetch('http://13.233.245.126:3000/usercount')
  ...
  fetch('http://13.233.245.126:3000/avggpa')
  .then(response => response.text())
  .then(data => {
    const result =data.split(/\s+/)
    console.log(result);
  ...
  fetch('http://13.233.245.126:3000/backlogcount')
  .then(response => response.text())
  .then(data => {
    const result =data.split(/\s+/)
    console.log(result);
  ...
  fetch('http://13.233.245.126:3000/nocert')
  .then(response => response.text())
  .then(data => {
    const result =data.split(/\s+/)
    let s11=result[0]
